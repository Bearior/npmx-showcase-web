          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex gap-3">
                <svg className="w-5 h-5 text-primary-400 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
              ...
              <li className="flex gap-3">
                <svg className="w-5 h-5 text-primary-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 0 1-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 0 0-1.091-.852H4.5A2.25 2.25 0 0 0 2.25 4.5v2.25Z" />
                </svg>
                <a href={`tel:${t.footer.phone.replace(/-/g, "")}`} className="text-sm text-gray-400 hover:text-primary-400 transition-colors">
                  {t.footer.phone}
                </a>
              </li>
              <li className="flex gap-3">
                ...
                <a href={`mailto:${t.footer.email}`} className="text-sm text-gray-400 hover:text-primary-400 transition-colors">
                  {t.footer.email}
                </a>
              </li>
              <li className="flex gap-3">
                ...
                <div className="text-sm text-gray-400">
                  ...
                  <p>{t.footer.weekendHours}: {t.footer.weekendHoursValue}</p>
                </div>
              </li>
            </ul>
          </div>
